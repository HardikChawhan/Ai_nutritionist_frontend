...
import { BrainCircuit, Activity, Database, Sparkles, User, ChevronRight, Apple, Star, MessageSquare, Clock, Github, Linkedin, Mail, Heart, ExternalLink, ShieldCheck, Lock, Server } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto selection:bg-accent/30">
      ...
      <motion.section
        ...
        whileInView={{ opacity: 1, y: 0 }}
        viewport={{ once: true }}
        className="max-w-5xl mx-auto py-16 border-t border-border/10"
      >
        <div className="text-center mb-10">
          ...
          <h2 className="text-2xl font-heading font-semibold">Your Data is Safe & Secure</h2>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="glass-panel p-6 text-center">
            <div className="w-12 h-12 rounded-xl bg-surface/50 border border-border/10 flex items-center justify-center mx-auto mb-4">
              <Lock className="w-6 h-6 text-emerald-400" />
            </div>
            <h3 className="font-semibold mb-2">256-bit Encryption</h3>
            <p className="text-sm text-muted">All biometric and dietary data is encrypted at rest and in transit using bank-level security.</p>
          </div>
          <div className="glass-panel p-6 text-center">
            <div className="w-12 h-12 rounded-xl bg-surface/50 border border-border/10 flex items-center justify-center mx-auto mb-4">
              <Server className="w-6 h-6 text-blue-400" />
            </div>
            <h3 className="font-semibold mb-2">HIPAA-Compliant Architecture</h3>
            <p className="text-sm text-muted">Our infrastructure is designed to meet strict healthcare data privacy and security regulations.</p>
          </div>
          <div className="glass-panel p-6 text-center">
            <div className="w-12 h-12 rounded-xl bg-surface/50 border border-border/10 flex items-center justify-center mx-auto mb-4">
            ...
            <p className="text-sm text-muted">You own your data. We never sell your personal information or health metrics to third parties.</p>
          </div>
        </div>
      </motion.section>

      {/* Medical Disclaimer & Health Regulations */}
      <section className="mt-20 py-12 border-t border-border/10 bg-surface/30 backdrop-blur-md text-center px-4 relative z-10 w-[100vw] relative left-[50%] right-[50%] -ml-[50vw] -mr-[50vw]">
        <div className="max-w-5xl mx-auto">
          <h4 className="text-sm font-bold text-foreground mb-4 tracking-widest uppercase">Health & Medical Disclaimer</h4>
          <p className="text-sm text-muted leading-relaxed max-w-4xl mx-auto">
            <strong className="text-foreground">Important Health Regulations:</strong> The information, meal plans, and workout guidance provided by AI Nutritionist are generated by artificial intelligence. This service is <strong>not</strong> a substitute for professional medical advice, diagnosis, or treatment. Always seek the advice of your physician, registered dietitian, or other qualified health provider with any questions you may have regarding a medical condition, dietary restrictions, or before commencing any new diet or exercise program. Artificial Intelligence can occasionally produce hallucinated or incorrect information. By using this service, you acknowledge and agree that your dietary choices are made at your own risk.
          </p>
        </div>
      </section>
